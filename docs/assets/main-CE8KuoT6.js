 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ld;function Jh(){if(Ld)return kl;Ld=1;var v=Kh(),z=Oh(),E=Bh();function h(a){var t="https://react.dev/errors/"+a;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var e=2;e<arguments.length;e++)t+="&args[]="+encodeURIComponent(arguments[e])}return"Minified React error #"+a+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function A(a){return!(!a||a.nodeType!==1&&a.nodeType!==9&&a.nodeType!==11)}var R=Symbol.for("react.element"),O=Symbol.for("react.transitional.element"),ea=Symbol.for("react.portal"),X=Symbol.for("react.fragment"),ca=Symbol.for("react.strict_mode"),ft=Symbol.for("react.profiler"),P=Symbol.for("react.provider"),ua=Symbol.for("react.consumer"),xa=Symbol.for("react.context"),Fa=Symbol.for("react.forward_ref"),mt=Symbol.for("react.suspense"),Oe=Symbol.for("react.suspense_list"),Be=Symbol.for("react.memo"),Ia=Symbol.for("react.lazy"),ne=Symbol.for("react.offscreen"),Sn=Symbol.for("react.memo_cache_sentinel"),le=Symbol.iterator;function Pa(a){return a===null||typeof a!="object"?null:(a=le&&a[le]||a["@@iterator"],typeof a=="function"?a:null)}var Al=Symbol.for("react.client.reference");function He(a){if(a==null)return null;if(typeof a=="function")return a.$$typeof===Al?null:a.displayName||a.name||null;if(typeof a=="string")return a;switch(a){case X:return"Fragment";case ea:return"Portal";case ft:return"Profiler";case ca:return"StrictMode";case mt:return"Suspense";case Oe:return"SuspenseList"}if(typeof a=="object")switch(a.$$typeof){case xa:return(a.displayName||"Context")+".Provider";case ua:return(a._context.displayName||"Context")+".Consumer";case Fa:var t=a.render;return a=a.displayName,a||(a=t.displayName||t.name||"",a=a!==""?"ForwardRef("+a+")":"ForwardRef"),a;case Be:return t=a.displayName||null,t!==null?t:He(a.type)||"Memo";case Ia:t=a._payload,a=a._init;try{return He(a(t))}catch{}}return null}var D=z.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,V=Object.assign,ht,wn;function ie(a){if(ht===void 0)try{throw Error()}catch(e){var t=e.stack.trim().match(/\n( *(at )?)/);ht=t&&t[1]||"",wn=-1<e.stack.indexOf(`
...
`;function ng(){const v=Hh(),z=Xd(),E=R=>{const O=document.getElementById(R);O==null||O.scrollIntoView({behavior:"smooth"})},h=R=>{z.pathname===R?window.scrollTo({top:0,behavior:"smooth"}):v(R)},A=(R,O)=>{if(R.preventDefault(),O.startsWith("#")){const ea=O.slice(1);z.pathname!=="/"?v("/",{state:{scrollTo:ea}}):E(ea)}else h(O)};return Me.useEffect(()=>{var O;const R=(O=z.state)==null?void 0:O.scrollTo;R&&E(R)},[z.state]),{handleClick:A}}const lg="/deskreview-react/svg/logo_full_navbar.svg";function ig(){const{handleClick:v}=ng(),z=[{href:"#work",label:"Work"},{href:"/",label:"Home"},{href:"/study",label:"Study"},{href:"#contact",label:"Contact"}];return y.jsx(Ph,{children:y.jsxs(ag,{children:[y.jsx(tg,{src:lg,alt:"Navbar_Logo",width:"120",height:"22","aria-label":"Home",onClick:E=>v(E,"/")}),y.jsx(eg,{children:z.map(E=>y.jsx(Qd,{to:E.href,onClick:h=>v(h,E.href),children:E.label},E.href))})]})})}const Kd=Uh.memo(ig),ug=I.footer`
  display: flex;
  flex-direction: row;
...
`;function rg(){const z=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hourCycle:"h23"});return y.jsx(ug,{children:y.jsxs("p",{children:["© 2025, Deskreview - ",z]})})}function Jd({children:v}){return y.jsxs(y.Fragment,{children:[y.jsx(Kd,{}),v,y.jsx(rg,{})]})}const Wd=I.main`
...
`;function cg({companyName:v,isOpen:z,onClick:E}){return y.jsxs(sg,{onClick:E,$isOpen:z,children:[y.jsx(Fd,{children:v}),y.jsx(Ch,{})]})}const og=I.div`
...
`;function Sg(){return y.jsxs(xl,{children:[y.jsx(Tl,{id:"contact",children:"Get in touch"}),y.jsxs(kg,{children:[y.jsxs(ts,{href:"mailto:zaidandzaki@gmail.com",target:"_blank",children:[y.jsx("p",{children:"Email us"}),y.jsx(Gh,{})]}),y.jsxs(ts,{href:"https://wa.me/+6285159177206",target:"_blank",children:[y.jsx("p",{children:"Chat with us"}),y.jsx(Lh,{})]}),y.jsxs(ts,{href:"https://www.instagram.com/deskreview/",target:"_blank",children:[y.jsx("p",{children:"Follow us"}),y.jsx(Yh,{})]})]})]})}function wg(){return y.jsxs(Wd,{children:[y.jsx(pg,{}),y.jsx(hg,{}),y.jsx(vg,{}),y.jsx(Sg,{})]})}function xg(){return y.jsx(Jd,{children:y.jsx(wg,{})})}const Tg=I.div`
  display: flex;
  flex-direction: column;
...
7.  Selesai, selamat kamu sudah mempunyai domain kamu sendiri, yeay!`,Id=Object.freeze(Object.defineProperty({__proto__:null,content:Eg,frontmatter:zg},Symbol.toStringTag,{value:"Module"})),jg={title:"Integration Test in React",description:"Practical exploration of integration testing in React by learning to simulate user behavior, add mocks, and assert client-side form native validation.",tag:"Blog",date:"14-01-2024",author:"Abdullah Ammar"},Dg=`\r
## Introduction\r
\r
...
`,tf=Object.freeze(Object.defineProperty({__proto__:null,content:Bg,frontmatter:Og},Symbol.toStringTag,{value:"Module"})),Hg={title:"Media Review: Monster (2023) and Human Instinct",linkname:"monster-and-human-instinct",date:"01-02-2024",tag:"Method Review",author:"Dzaki Zaidan"},Ug=`![](https://miro.medium.com/v2/resize:fit:1050/1*bMfostBlTBswS6WzPdSF-Q.jpeg)\r
\r
...
*   [https://www.reuters.com/lifestyle/japans-kore-eda-sexual-identity-not-focus-film-monster-2023-05-18/](https://www.reuters.com/lifestyle/japans-kore-eda-sexual-identity-not-focus-film-monster-2023-05-18/)\r
    \r
*   [https://deadline.com/2023/05/hirokazu-kore-eda-monster-lgbtq-themes-cannes-1235371202/](https://deadline.com/2023/05/hirokazu-kore-eda-monster-lgbtq-themes-cannes-1235371202/)`,ef=Object.freeze(Object.defineProperty({__proto__:null,content:Ug,frontmatter:Hg},Symbol.toStringTag,{value:"Module"})),Rg={title:"Opinion: Aesthetica of (my) Human Experience at Kongsi 8",linkname:"opinion-aesthetica",date:"10-07-2024",tag:"On-Review",author:"Dzaki Zaidan"},Ng=`\r
...
`,nf=Object.freeze(Object.defineProperty({__proto__:null,content:Ng,frontmatter:Rg},Symbol.toStringTag,{value:"Module"})),qg={title:"Organizing React Code",description:"How I code in React",tag:"Blog",keywords:["React","State Mangement","User Interface"],status:"Draft",publishedAt:"2024-06-14",author:"Abdullah Ammar"},Cg=`\r
...
`,uf=Object.freeze(Object.defineProperty({__proto__:null,content:Lg,frontmatter:Gg},Symbol.toStringTag,{value:"Module"})),Yg={title:"Tailwind Prose"},Vg=`\r
<p className="lead">\r
...
`,rf=Object.freeze(Object.defineProperty({__proto__:null,content:Vg,frontmatter:Yg},Symbol.toStringTag,{value:"Module"})),Xg={title:"Testing dan Test-Driven Development",subtitle:'"Kenapa kode harus dites? memang perlu? memang ngga makan banyak waktu?"',description:"Rangkuman pembelajaran saya mengenai Testing dan Test-Driven Development menggunakan Jest dan React Testing Library ",tag:"Blog",keywords:["Testing","TDD","Learning","Jest","React Testing Library"],status:"In Progress",publishedAt:"2021-09-12",updatedAt:"2021-09-12",image:"../../assets/blog/testing-dan-tdd/testing-dan-tdd.webp",imageAlt:"Ilustrasi botol kaca lab sebagai logo",author:"Abdullah Ammar"},Qg=`\r
...
`,sf=Object.freeze(Object.defineProperty({__proto__:null,content:Qg,frontmatter:Xg},Symbol.toStringTag,{value:"Module"})),Li=v=>{const[z,E,h]=v.split("-");return new Date(`${h}-${E}-${z}`)},Zg=v=>Zd(Li(v),"dd-MM-yyyy"),pp=v=>Zd(Li(v),"MMMM dd, yyyy"),Kg=v=>{var z;return((z=v.match(/\/([^/]+)\.md$/))==null?void 0:z[1])||""},Jg=()=>Object.assign({"../contents/custom-domain-tech.md":Id,"../contents/integration-test-in-react.md":Pd,"../contents/kau-aku-jazz.md":af,"../contents/membangun-kebun-digital.md":tf,"../contents/monster-and-human.md":ef,"../contents/opinion-aesthetica.md":nf,"../contents/organizing-react-code.md":lf,"../contents/pengujian-ce.md":uf,"../contents/tailwind-prose.md":rf,"../contents/testing-dan-tdd.md":sf}),Wg=v=>Object.entries(v).sort(([,z],[,E])=>{const h=z.frontmatter.date?Li(z.frontmatter.date):new Date(0),A=E.frontmatter.date?Li(E.frontmatter.date):new Date(0);return Vh(h,A)}),$g=v=>v.map(([z,E])=>{const h=Kg(z),{frontmatter:A}=E,R=A.title||"Untitled",O=A.date?Zg(A.date):null;return{title:R,path:`/study/${h}`,date:O}});function Fg(){const v=Jg(),z=Wg(v),E=$g(z);return y.jsx(Wd,{children:y.jsxs(xl,{children:[y.jsx(Tl,{children:"Study"}),E.length>0&&y.jsxs(Tg,{children:[y.jsx(kn,{}),E.map(({title:h,path:A,date:R})=>y.jsxs(y.Fragment,{children:[y.jsxs(Ag,{to:A,children:[R&&y.jsx("p",{className:"blog-date",children:R}),y.jsx("p",{className:"blog-title",children:h})]},A),y.jsx(kn,{})]}))]})]})})}function Ig(){return y.jsx(Jd,{children:y.jsx(Fg,{})})}function Pg(){return y.jsxs(y.Fragment,{children:[y.jsx(ap,{children:y.jsx(Kd,{})}),y.jsxs(tp,{children:[y.jsx("p",{children:"404"}),y.jsx("p",{children:"Not Found"})]})]})}const ap=I.div`
  nav {
    position: fixed;
  }
`,tp=I.main`
