const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BlogPost-DUIcWnzy.js","assets/react-markdown-CR5Xb4Lj.js","assets/vendor-CvfCuUZz.js","assets/styled-components-BOF5XIQs.js","assets/@radix-ui/react-icons-T6wVLuVb.js","assets/date-fns-B4QYC8g5.js","assets/remark-gfm-DhOrmXei.js"])))=>i.map(i=>d[i]);
import{p,M as zh}from"./react-markdown-CR5Xb4Lj.js";import{a as Dh,b as _h,u as Zf,r as Me,c as jh,L as Mh,R as Tl,d as Oh,B as Bh}from"./vendor-CvfCuUZz.js";import{f as Hh,d as F}from"./styled-components-BOF5XIQs.js";import{C as Uh,E as Rh,a as Nh,I as qh}from"./@radix-ui/react-icons-T6wVLuVb.js";import{f as Kf,c as Ch}from"./date-fns-B4QYC8g5.js";import{r as Gh}from"./remark-gfm-DhOrmXei.js";(function(){const E=document.createElement("link").relList;if(E&&E.supports&&E.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))h(A);new MutationObserver(A=>{for(const R of A)if(R.type==="childList")for(const O of R.addedNodes)O.tagName==="LINK"&&O.rel==="modulepreload"&&h(O)}).observe(document,{childList:!0,subtree:!0});function z(A){const R={};return A.integrity&&(R.integrity=A.integrity),A.referrerPolicy&&(R.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?R.credentials="include":A.crossOrigin==="anonymous"?R.credentials="omit":R.credentials="same-origin",R}function h(A){if(A.ep)return;A.ep=!0;const R=z(A);fetch(A.href,R)}})();var Ir={exports:{}},kl={},Pr={exports:{}},tc={};/**
 * @license React
...
`;function Ih(){const k=jh(),E=Zf(),z=R=>{const O=document.getElementById(R);O==null||O.scrollIntoView({behavior:"smooth"})},h=R=>{E.pathname===R?window.scrollTo({top:0,behavior:"smooth"}):k(R)},A=(R,O)=>{if(R.preventDefault(),O.startsWith("#")){const et=O.slice(1);E.pathname!=="/"?k("/",{state:{scrollTo:et}}):z(et)}else h(O)};return Me.useEffect(()=>{var O;const R=(O=E.state)==null?void 0:O.scrollTo;R&&z(R)},[E.state]),{handleClick:A}}const Ph="/deskreview-react/svg/logo_full_navbar.svg";function ec(){const{handleClick:k}=Ih(),E=[{href:"#work",label:"Work"},{href:"/",label:"Home"},{href:"/blog",label:"Study"},{href:"#contact",label:"Contact"}];return p.jsx(Jh,{children:p.jsxs(Wh,{children:[p.jsx("a",{href:"/",onClick:z=>k(z,"/"),children:p.jsx(Fh,{src:Ph,alt:"Navbar_Logo",width:"120",height:"30"})}),p.jsx($h,{children:E.map(z=>p.jsx("a",{href:z.href,onClick:h=>k(h,z.href),children:z.label},z.href))})]})})}const tg=F.footer`
  display: flex;
  flex-direction: row;
...
`;function Jf(){const E=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hourCycle:"h23"});return p.jsx(tg,{children:p.jsxs("p",{children:["© 2025, Deskreview - ",E]})})}const Wf=F.main`
...
`;function eg({companyName:k,isOpen:E,onClick:z}){return p.jsxs(ag,{onClick:z,$isOpen:E,children:[p.jsx($f,{children:k}),p.jsx(Uh,{})]})}const ng=F.div`
...
`;function hg(){return p.jsxs(xl,{children:[p.jsx(wl,{id:"contact",children:"Get in touch"}),p.jsxs(mg,{children:[p.jsxs(ac,{href:"mailto:zaidandzaki@gmail.com",target:"_blank",children:[p.jsx("p",{children:"Email us"}),p.jsx(Rh,{})]}),p.jsxs(ac,{href:"https://wa.me/+6285159177206",target:"_blank",children:[p.jsx("p",{children:"Chat with us"}),p.jsx(Nh,{})]}),p.jsxs(ac,{href:"https://www.instagram.com/deskreview/",target:"_blank",children:[p.jsx("p",{children:"Follow us"}),p.jsx(qh,{})]})]})]})}function gg(){return p.jsxs(Wf,{children:[p.jsx(sg,{}),p.jsx(rg,{}),p.jsx(dg,{}),p.jsx(hg,{})]})}function pg(){return p.jsxs(p.Fragment,{children:[p.jsx(ec,{}),p.jsx(gg,{}),p.jsx(Jf,{})]})}F.section`
  max-width: 500px;
  width: 100%;
  margin: 0px auto 40px;
...
`;const yg=F.div`
  display: flex;
  flex-direction: column;
`,bg={title:"Mengatur Custom Domain .tech di Github Pages",description:"Mengatur custom domain .tech di Github Pages secara gampang",tag:"On-Review",date:"03-01-2023",author:"Abdullah Ammar"},vg=`\r
...
`,Pf=Object.freeze(Object.defineProperty({__proto__:null,content:Sg,frontmatter:kg},Symbol.toStringTag,{value:"Module"})),Tg={title:"Membangun Kebun Digital",description:"Membangun sebuah tempat untuk belajar dan menumbuhkan ide-ide baru di ruang publik",date:"06-09-2021",author:"Abdullah Ammar"},xg=`\r
...
`,td=Object.freeze(Object.defineProperty({__proto__:null,content:xg,frontmatter:Tg},Symbol.toStringTag,{value:"Module"})),wg={title:"Organizing React Code",description:"How I code in React",tag:"Blog",keywords:["React","State Mangement","User Interface"],status:"Draft",publishedAt:"2024-06-14",author:"Abdullah Ammar"},Ag=`\r
...
\`\`\`\r
\r
`,ad=Object.freeze(Object.defineProperty({__proto__:null,content:Ag,frontmatter:wg},Symbol.toStringTag,{value:"Module"})),Eg={title:"Pengujian Web Component",description:"Tutorial singkat pengujian web component menggunakan AVA dan Happy DOM",tag:"Blog",keywords:["Testing","Custom Elements","Web Components"],status:"In Progress",publishedAt:"2021-12-23",image:"../../assets/blog/pengujian-ce/pengujian-ce.webp",imageAlt:"Ilustrasi Testing",author:"Abdullah Ammar"},zg=`\r
...
`,ed=Object.freeze(Object.defineProperty({__proto__:null,content:zg,frontmatter:Eg},Symbol.toStringTag,{value:"Module"})),Dg={title:"Tailwind Prose"},_g=`\r
...
`,nd=Object.freeze(Object.defineProperty({__proto__:null,content:_g,frontmatter:Dg},Symbol.toStringTag,{value:"Module"})),jg={title:"Testing dan Test-Driven Development",subtitle:'"Kenapa kode harus dites? memang perlu? memang ngga makan banyak waktu?"',description:"Rangkuman pembelajaran saya mengenai Testing dan Test-Driven Development menggunakan Jest dan React Testing Library ",tag:"Blog",keywords:["Testing","TDD","Learning","Jest","React Testing Library"],status:"In Progress",publishedAt:"2021-09-12",updatedAt:"2021-09-12",image:"../../assets/blog/testing-dan-tdd/testing-dan-tdd.webp",imageAlt:"Ilustrasi botol kaca lab sebagai logo",author:"Abdullah Ammar"},Mg=`\r
...
`,ld=Object.freeze(Object.defineProperty({__proto__:null,content:Mg,frontmatter:jg},Symbol.toStringTag,{value:"Module"})),Yi=k=>{const[E,z,h]=k.split("-");return new Date(`${h}-${z}-${E}`)},Og=k=>Kf(Yi(k),"dd/MM/yyyy"),ep=k=>Kf(Yi(k),"MMMM dd, yyyy"),Bg=k=>{var E;return((E=k.match(/\/([^/]+)\.md$/))==null?void 0:E[1])||""},Hg=()=>Object.assign({"../contents/custom-domain-tech.md":If,"../contents/integration-test-in-react.md":Pf,"../contents/membangun-kebun-digital.md":td,"../contents/organizing-react-code.md":ad,"../contents/pengujian-ce.md":ed,"../contents/tailwind-prose.md":nd,"../contents/testing-dan-tdd.md":ld}),Ug=k=>Object.entries(k).sort(([,E],[,z])=>{const h=E.frontmatter.date?Yi(E.frontmatter.date):new Date(0),A=z.frontmatter.date?Yi(z.frontmatter.date):new Date(0);return Ch(h,A)}),Rg=k=>k.map(([E,z])=>{const h=Bg(E),{frontmatter:A}=z,R=A.title||"Untitled",O=A.date?Og(A.date):null;return{title:R,path:`/blog/${h}`,date:O}});function Ng(){const k=Hg(),E=Ug(k),z=Rg(E);return p.jsx(Wf,{children:p.jsxs(xl,{children:[p.jsx(wl,{children:"Study"}),p.jsxs(yg,{children:[p.jsx(kn,{}),z.map(({title:h,path:A,date:R})=>p.jsxs(p.Fragment,{children:[p.jsxs(qg,{to:A,children:[p.jsx("p",{children:h}),p.jsx("p",{children:R&&`${R}`})]},A),p.jsx(kn,{})]}))]})]})})}const qg=F(Mh)`
  padding: 12px 0;
  display: flex;
  justify-content: space-between;
...
`;function Cg(){return p.jsxs(p.Fragment,{children:[p.jsx(ec,{}),p.jsx(Ng,{}),p.jsx(Jf,{})]})}function Gg(){return p.jsxs(p.Fragment,{children:[p.jsx(Yg,{children:p.jsx(ec,{})}),p.jsxs(Lg,{children:[p.jsx("p",{children:"404"}),p.jsx("p",{children:"Not Found"})]})]})}const Yg=F.div`
  nav {
    position: fixed;
  }
`,Lg=F.main`
...
`,Vg="modulepreload",Xg=function(k){return"/deskreview-react/"+k},Qf={},Qg=function(E,z,h){let A=Promise.resolve();if(z&&z.length>0){document.getElementsByTagName("link");const O=document.querySelector("meta[property=csp-nonce]"),et=(O==null?void 0:O.nonce)||(O==null?void 0:O.getAttribute("nonce"));A=Promise.allSettled(z.map(X=>{if(X=Xg(X),X in Qf)return;Qf[X]=!0;const st=X.endsWith(".css"),da=st?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${X}"]${da}`))return;const P=document.createElement("link");if(P.rel=st?"stylesheet":Vg,st||(P.as="script"),P.crossOrigin="",P.href=X,et&&P.setAttribute("nonce",et),document.head.appendChild(P),st)return new Promise((ut,xt)=>{P.addEventListener("load",ut),P.addEventListener("error",()=>xt(new Error(`Unable to preload CSS for ${X}`)))})}))}function R(O){const et=new Event("vite:preloadError",{cancelable:!0});if(et.payload=O,window.dispatchEvent(et),!et.defaultPrevented)throw O}return A.then(O=>{for(const et of O||[])et.status==="rejected"&&R(et.reason);return E().catch(R)})};function Zg(){return Object.entries(Object.assign({"../contents/custom-domain-tech.md":If,"../contents/integration-test-in-react.md":Pf,"../contents/membangun-kebun-digital.md":td,"../contents/organizing-react-code.md":ad,"../contents/pengujian-ce.md":ed,"../contents/tailwind-prose.md":nd,"../contents/testing-dan-tdd.md":ld})).map(([E,z])=>{var O;const h=((O=E.match(/\/([^/]+)\.md$/))==null?void 0:O[1])||"",{frontmatter:A,content:R}=z;return{path:h,frontmatter:A,content:R}})}const Kg=Me.lazy(()=>Qg(()=>import("./BlogPost-DUIcWnzy.js"),__vite__mapDeps([0,1,2,3,4,5,6])));function Jg(){return Zg().map(({path:E,frontmatter:z,content:h})=>p.jsx(Tl,{path:E,element:p.jsx(Kg,{frontmatter:z,children:p.jsx(zh,{children:h,remarkPlugins:[Gh]})})},E))}function Wg(){const k=Jg();return p.jsxs(p.Fragment,{children:[p.jsx(Kh,{}),p.jsxs(Oh,{children:[p.jsx(Tl,{path:"/",element:p.jsx(pg,{})}),p.jsxs(Tl,{path:"/blog",children:[p.jsx(Tl,{index:!0,element:p.jsx(Cg,{})}),k]}),p.jsx(Tl,{path:"*",element:p.jsx(Gg,{})})]})]})}Qh.createRoot(document.getElementById("root")).render(p.jsx(Me.StrictMode,{children:p.jsxs(Bh,{basename:"/deskreview-react/",children:[p.jsx(Zh,{}),p.jsx(Wg,{})]})}));export{Jf as F,Wf as M,ec as N,xl as S,ep as f};
