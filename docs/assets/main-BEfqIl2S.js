...
`;function ig(){const z=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hourCycle:"h23"});return y.jsx(lg,{children:y.jsxs("p",{children:["© 2025, Deskreview - ",z]})})}function Jd({children:v}){return y.jsxs(y.Fragment,{children:[y.jsx(Kd,{}),v,y.jsx(ig,{})]})}const Wd=$.main`
...
`;function rg({companyName:v,isOpen:z,onClick:E}){return y.jsxs(ug,{onClick:E,$isOpen:z,children:[y.jsx(Fd,{children:v}),y.jsx(qh,{})]})}const sg=$.div`
...
`;function vg(){return y.jsxs(xl,{children:[y.jsx(Tl,{id:"contact",children:"Get in touch"}),y.jsxs(bg,{children:[y.jsxs(ts,{href:"mailto:zaidandzaki@gmail.com",target:"_blank",children:[y.jsx("p",{children:"Email us"}),y.jsx(Ch,{})]}),y.jsxs(ts,{href:"https://wa.me/+6285159177206",target:"_blank",children:[y.jsx("p",{children:"Chat with us"}),y.jsx(Gh,{})]}),y.jsxs(ts,{href:"https://www.instagram.com/deskreview/",target:"_blank",children:[y.jsx("p",{children:"Follow us"}),y.jsx(Yh,{})]})]})]})}function kg(){return y.jsxs(Wd,{children:[y.jsx(hg,{}),y.jsx(fg,{}),y.jsx(yg,{}),y.jsx(vg,{})]})}function Sg(){return y.jsx(Jd,{children:y.jsx(kg,{})})}$.section`
  max-width: 500px;
  width: 100%;
  margin: 0px auto 40px;
...
7.  Selesai, selamat kamu sudah mempunyai domain kamu sendiri, yeay!`,Id=Object.freeze(Object.defineProperty({__proto__:null,content:Tg,frontmatter:xg},Symbol.toStringTag,{value:"Module"})),Ag={title:"Media Review: Monster (2023) and Human Instinct",linkname:"monster-and-human-instinct",date:"01-02-2024",tag:"Method Review",author:"Dzaki Zaidan"},zg=`![](https://miro.medium.com/v2/resize:fit:1050/1*bMfostBlTBswS6WzPdSF-Q.jpeg)\r
\r
...
`,af=Object.freeze(Object.defineProperty({__proto__:null,content:jg,frontmatter:Eg},Symbol.toStringTag,{value:"Module"})),Dg={title:"Fiction: Kau dan Aku jadi Jazz",linkname:"kau-aku-jazz",date:"10-05-2024",tag:"Method Review",author:"Dzaki Zaidan"},_g=`kenapa hidup ini harus beraspek lain selain sonik musik dan romansa puan?\r
\r
...
`,ef=Object.freeze(Object.defineProperty({__proto__:null,content:Og,frontmatter:Mg},Symbol.toStringTag,{value:"Module"})),Bg={title:"Opinion: Aesthetica of (my) Human Experience at Kongsi 8",linkname:"opinion-aesthetica",date:"10-07-2024",tag:"On-Review",author:"Dzaki Zaidan"},Hg=`\r
...
`,nf=Object.freeze(Object.defineProperty({__proto__:null,content:Hg,frontmatter:Bg},Symbol.toStringTag,{value:"Module"})),Ug={title:"Organizing React Code",description:"How I code in React",tag:"Blog",keywords:["React","State Mangement","User Interface"],status:"Draft",publishedAt:"2024-06-14",author:"Abdullah Ammar"},Rg=`\r
...
\`\`\`\r
\r
`,lf=Object.freeze(Object.defineProperty({__proto__:null,content:Rg,frontmatter:Ug},Symbol.toStringTag,{value:"Module"})),Ng={title:"Pengujian Web Component",description:"Tutorial singkat pengujian web component menggunakan AVA dan Happy DOM",tag:"Blog",keywords:["Testing","Custom Elements","Web Components"],status:"In Progress",publishedAt:"2021-12-23",image:"../../assets/blog/pengujian-ce/pengujian-ce.webp",imageAlt:"Ilustrasi Testing",author:"Abdullah Ammar"},qg=`\r
...
`,uf=Object.freeze(Object.defineProperty({__proto__:null,content:qg,frontmatter:Ng},Symbol.toStringTag,{value:"Module"})),Cg={title:"Tailwind Prose"},Gg=`\r
...
`,rf=Object.freeze(Object.defineProperty({__proto__:null,content:Gg,frontmatter:Cg},Symbol.toStringTag,{value:"Module"})),Yg={title:"Testing dan Test-Driven Development",subtitle:'"Kenapa kode harus dites? memang perlu? memang ngga makan banyak waktu?"',description:"Rangkuman pembelajaran saya mengenai Testing dan Test-Driven Development menggunakan Jest dan React Testing Library ",tag:"Blog",keywords:["Testing","TDD","Learning","Jest","React Testing Library"],status:"In Progress",publishedAt:"2021-09-12",updatedAt:"2021-09-12",image:"../../assets/blog/testing-dan-tdd/testing-dan-tdd.webp",imageAlt:"Ilustrasi botol kaca lab sebagai logo",author:"Abdullah Ammar"},Lg=`\r
...
`,sf=Object.freeze(Object.defineProperty({__proto__:null,content:Lg,frontmatter:Yg},Symbol.toStringTag,{value:"Module"})),Yi=v=>{const[z,E,h]=v.split("-");return new Date(`${h}-${E}-${z}`)},Vg=v=>Zd(Yi(v),"dd/MM/yyyy"),hp=v=>Zd(Yi(v),"MMMM dd, yyyy"),Xg=v=>{var z;return((z=v.match(/\/([^/]+)\.md$/))==null?void 0:z[1])||""},Qg=()=>Object.assign({"../contents/custom-domain-tech.md":Id,"../contents/field.linkname.md":Pd,"../contents/integration-test-in-react.md":af,"../contents/kau-aku-jazz.md":tf,"../contents/membangun-kebun-digital.md":ef,"../contents/opinion-aesthetica.md":nf,"../contents/organizing-react-code.md":lf,"../contents/pengujian-ce.md":uf,"../contents/tailwind-prose.md":rf,"../contents/testing-dan-tdd.md":sf}),Zg=v=>Object.entries(v).sort(([,z],[,E])=>{const h=z.frontmatter.date?Yi(z.frontmatter.date):new Date(0),A=E.frontmatter.date?Yi(E.frontmatter.date):new Date(0);return Lh(h,A)}),Kg=v=>v.map(([z,E])=>{const h=Xg(z),{frontmatter:A}=E,R=A.title||"Untitled",O=A.date?Vg(A.date):null;return{title:R,path:`/blog/${h}`,date:O}});function Jg(){const v=Qg(),z=Zg(v),E=Kg(z);return y.jsx(Wd,{children:y.jsxs(xl,{children:[y.jsx(Tl,{children:"Study"}),y.jsxs(wg,{children:[y.jsx(kn,{}),E.map(({title:h,path:A,date:R})=>y.jsxs(y.Fragment,{children:[y.jsxs(Wg,{to:A,children:[y.jsx("p",{children:h}),y.jsx("p",{children:R&&`${R}`})]},A),y.jsx(kn,{})]}))]})]})})}const Wg=$(Qd)`
  padding: 12px 0;
  display: flex;
  justify-content: space-between;
...
`;function $g(){return y.jsx(Jd,{children:y.jsx(Jg,{})})}function Fg(){return y.jsxs(y.Fragment,{children:[y.jsx(Ig,{children:y.jsx(Kd,{})}),y.jsxs(Pg,{children:[y.jsx("p",{children:"404"}),y.jsx("p",{children:"Not Found"})]})]})}const Ig=$.div`
  nav {
    position: fixed;
  }
`,Pg=$.main`
